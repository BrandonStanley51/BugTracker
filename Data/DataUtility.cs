...
namespace BugTracker.Data
{
    ...
    {
        //Get company Ids
        private static int demoCompanyId;
        ...
        public static async Task SeedDefaultCompaniesAsync(ApplicationDbContext context)
        {
            try
            {
                ...
                //Get company Ids
                demoCompanyId = context.Company.FirstOrDefault(p => p.Name == "DemoCompany").Id;
        ...
        public static async Task SeedDefaultUsersAsync(UserManager<BTUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            {
                UserName = "brandonstanley51@gmail.com",
                Email = "brandonstanley51@gmail.com",
                FirstName = "Brandon",
                LastName = "Stanley",
                EmailConfirmed = true,
                CompanyId = demoCompanyId
            ...
            {
                UserName = "demoprojectman@demo.com",
                Email = "demoprojectman@demo.com",
                FirstName = "Demo",
                LastName = "Pr.Manager",
                EmailConfirmed = true,
                CompanyId = demoCompanyId
            ...
            defaultUser = new BTUser
            {
                UserName = "demoprojectman2@demo.com",
                Email = "demoprojectman2@demo.com",
                FirstName = "Demo",
                LastName = "Pr.Man2",
                EmailConfirmed = true,
                CompanyId = demoCompanyId
            ...
            defaultUser = new BTUser
            {
                UserName = "demodev@demo.com",
                Email = "demodev@demo.com",
                FirstName = "Demo",
                LastName = "Dev",
                EmailConfirmed = true,
                CompanyId = demoCompanyId
            ...
            defaultUser = new BTUser
            {
                UserName = "demosub@demo.com",
                Email = "demosub@demo.com",
                FirstName = "Demo",
                LastName = "Sub",
                EmailConfirmed = true,
                CompanyId = demoCompanyId
        ...
        public static async Task SeedDefaultTicketStatusAsync(ApplicationDbContext context)
        {
            try
            {
                IList<TicketStatus> ticketStatuses = new List<TicketStatus>() {
                    ...
                    new TicketStatus() { Name = "Unassigned" },          // Ticket is currently unassigned
